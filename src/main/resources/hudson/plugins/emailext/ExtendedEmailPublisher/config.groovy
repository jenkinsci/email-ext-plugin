...
f.entry(title: _("Project From")) {
  f.textbox(name: "from", value: configured ? instance.from : "")
}
f.entry(title: _("Project Recipient List"), help: "/plugin/email-ext/help/projectConfig/globalRecipientList.html", description: _("Comma-separated list of email address that should receive notifications for this project.")) {
  f.textarea(name: "recipientList", value: configured ? instance.recipientList : "\$DEFAULT_RECIPIENTS", checkUrl: "${rootURL}/publisher/ExtendedEmailPublisher/recipientListRecipientsCheck", checkDependsOn: "")
}
...
f.entry(title: _("Default Subject"), help: "/plugin/email-ext/help/projectConfig/defaultSubject.html") {
  f.textbox(name: "defaultSubject", value: configured ? instance.defaultSubject : "\$DEFAULT_SUBJECT")
}
f.entry(title: _("Default Content"), help: "/plugin/email-ext/help/projectConfig/defaultBody.html") {
  f.textarea(name: "defaultContent", value: configured ? instance.defaultContent : "\$DEFAULT_CONTENT")
}
...
f.advanced(title: _("Advanced Settings")) {
  f.entry(title: _("Pre-send Script"), help: "/plugin/email-ext/help/projectConfig/presendScript.html") {
    f.textarea(id: "project_presend_script", name: "presendScript", value: configured ? instance.presendScript : "\$DEFAULT_PRESEND_SCRIPT", class: "setting-input")
  }
  ...
  f.entry(title: _("Triggers"), help: "/plugin/email-ext/help/projectConfig/addATrigger.html") {
    f.hetero_list(name: "configuredTriggers", hasHeader: true, descriptors: triggers, items: configuredTriggers, addCaption:_("Add Trigger"), deleteCaption: _("Remove Trigger"), capture: "showSendTo")
  }
}
