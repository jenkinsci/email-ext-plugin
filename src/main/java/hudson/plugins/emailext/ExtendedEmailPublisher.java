...
public class ExtendedEmailPublisher extends Notifier implements MatrixAggregatable {
	...
	public ExtendedEmailPublisher(String project_recipient_list, String project_content_type, String project_default_subject,
			...
			int project_attach_buildlog, String project_replyto, boolean project_save_output,boolean project_cssinline_enabled,
		...
		this(project_recipient_list, project_content_type, project_default_subject, project_default_content,
				...
				project_save_output, project_triggers, matrixTriggerMode, false,project_cssinline_enabled, Collections.EMPTY_LIST);
	}
	...
	public ExtendedEmailPublisher(String project_recipient_list, String project_content_type, String project_default_subject,
			...
			List<EmailTrigger> project_triggers, MatrixTriggerMode matrixTriggerMode, boolean project_disabled,boolean project_cssinline_enabled,
		...
		this.cssInlineEnable = project_cssinline_enabled;
