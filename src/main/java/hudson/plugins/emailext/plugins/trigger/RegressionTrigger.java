...
public class RegressionTrigger extends EmailTrigger {
    ...
    public RegressionTrigger(boolean sendToList, boolean sendToDevs, boolean sendToRequestor, boolean sendToCulprits, boolean sendToUpstream, String recipientList,
