...
public class FailureTrigger extends EmailTrigger {
    ...
    public static FailureTrigger createDefault() {
        return new FailureTrigger(false, true, true, true, true, "", "$PROJECT_DEFAULT_REPLYTO", "$PROJECT_DEFAULT_SUBJECT", "$PROJECT_DEFAULT_CONTENT", "", 0, "project");
    }
    
    @DataBoundConstructor
    public FailureTrigger(boolean sendToList, boolean sendToDevs, boolean sendToRequestor, boolean sendToCulprits, boolean sendToUpstream, String recipientList,
