...
public class AbortedTrigger extends AbstractEmailTrigger {

    public static final String TRIGGER_NAME = "Aborted";
    
    @DataBoundConstructor
    public AbortedTrigger(List<AbstractRecipientProvider> recipientProviders, String recipientList, String replyTo, String subject, String body, String attachmentsPattern, int attachBuildLog, String contentType) {
