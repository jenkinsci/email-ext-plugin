...
public class SecondFailureTrigger extends AbstractNthFailureTrigger {
    ...
    public SecondFailureTrigger(List<hudson.plugins.emailext.plugins.AbstractRecipientProvider> recipientProviders, String recipientList, String replyTo, String subject, String body, String attachmentsPattern, int attachBuildLog, String contentType) {
    ...
    @Extension
    public static final class DescriptorImpl extends AbstractNthFailureTrigger.DescriptorImpl {
