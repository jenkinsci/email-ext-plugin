...
public class StillUnstableTrigger extends hudson.plugins.emailext.plugins.AbstractEmailTrigger {

    public static final String TRIGGER_NAME = "Unstable (Test Failures) - Still";
    
    @DataBoundConstructor
    public StillUnstableTrigger(List<hudson.plugins.emailext.plugins.AbstractRecipientProvider> recipientProviders, String recipientList, String replyTo,
