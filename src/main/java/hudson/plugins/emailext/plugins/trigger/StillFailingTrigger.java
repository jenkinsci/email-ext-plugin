...
public class StillFailingTrigger extends EmailTrigger {
    ...
    public StillFailingTrigger(boolean sendToList, boolean sendToDevs, boolean sendToRequestor, boolean sendToCulprits, boolean sendToUpstream, String recipientList,
