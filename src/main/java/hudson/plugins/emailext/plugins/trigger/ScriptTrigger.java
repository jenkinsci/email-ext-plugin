...
public class ScriptTrigger extends AbstractScriptTrigger {
    ...
    public ScriptTrigger(List<AbstractRecipientProvider> recipientProviders, String recipientList, String replyTo, String subject, String body, String attachmentsPattern, int attachBuildLog, String contentType, String triggerScript) {
    ...
    @Extension
    public static class DescriptorImpl extends AbstractEmailTriggerDescriptor {
