 ...
 */
public abstract class AbstractTriggerTestBase {
    
    protected List<hudson.plugins.emailext.plugins.AbstractRecipientProvider> recProviders = Collections.emptyList();

    abstract hudson.plugins.emailext.plugins.AbstractEmailTrigger newInstance();
    ...
    void assertTriggered(Result... resultHistory)
        ...
        hudson.plugins.emailext.plugins.AbstractEmailTrigger trigger = newInstance();
