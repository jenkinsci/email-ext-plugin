...
* `build` (https://javadoc.jenkins-ci.org/hudson/model/AbstractBuild.html[`hudson.model.AbstractBuild`]) - The build this message belongs to (only use with Freestyle projects).
* `run` (https://javadoc.jenkins-ci.org/hudson/model/Run.html[`hudson.model.Run`]) - The build this message belongs to (may be used with Freestyle projects or Pipeline).
...
* `build` (https://javadoc.jenkins-ci.org/hudson/model/AbstractBuild.html[`hudson.model.AbstractBuild`]): This is the current build, usually a subclass of `AbstractBuild`.
* `project` (https://javadoc.jenkins-ci.org/hudson/model/AbstractProject.html[`hudson.model.AbstractProject`]): The project object that the current build was started from, usually a subclass of `AbstractProject`.
...
including
https://javadoc.jenkins-ci.org/hudson/model/AbstractBuild.html[`hudson.model.AbstractBuild`]
and
https://javadoc.jenkins-ci.org/hudson/model/AbstractProject.html[`hudson.model.AbstractProject`].
For an example on how to do this, take a look at the existing
